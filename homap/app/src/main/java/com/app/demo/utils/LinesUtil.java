...
public class LinesUtil {
    ...
    public static final String Near_URL = "https://api.jisuapi.com/transit/nearby"; //站点
    public static final String Line_URL = "https://api.jisuapi.com/transit/line"; //线路
...
//        String url = URL + "?city=" + URLEncoder.encode(city, "utf-8") + "&start=" + URLEncoder.encode(start, "utf-8") + "&end" + URLEncoder.encode(end, "utf-8") + "&appkey=" + APPKEY;
    ...
    //附近站点
    public static void GetLine(Context context, String city, String transitno, I_success i_success) {
//        String url = URL + "?city=" + URLEncoder.encode(city, "utf-8") + "&start=" + URLEncoder.encode(start, "utf-8") + "&end" + URLEncoder.encode(end, "utf-8") + "&appkey=" + APPKEY;
        String url = Line_URL + "?city=" + city + "&transitno=" + transitno + "&appkey=" + APPKEY;
        getHttp(context, url, i_success);
    }
